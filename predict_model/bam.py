...
def Xception_DeepLabV3_Plus_bam(shape=(512, 512, 3), num_classes=2):
...
'''
model = Xception_DeepLabV3_Plus_bam()
try:
    model.load_weights(r'D:\ProjectSummary\build_detection\predict_model\bam.h5')
    print('load weights bam')
except OSError as e:
...
def detection(img_arr, save_path=None):
    ...
    cv.imwrite('D:/ProjectSummary/build_detection/all_result/bam.png', pred_result[:h,:w],
